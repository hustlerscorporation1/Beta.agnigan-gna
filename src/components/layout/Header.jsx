            ...
            >
                <div className="bg-white rounded-2xl shadow-2xl overflow-hidden mx-4">
                  ...
                  <div className="bg-gradient-to-r from-primary-600 to-primary-800 p-6 text-white">
                    <div className="flex items-center justify-between">
                      <div>
                        <h3 className="text-2xl font-bold mb-2">Télécharger l'application</h3>
                        <p className="text-primary-100 text-sm">Accédez à vos terrains partout, tout le temps</p>
                      </div>
                      <button
                        onClick={() => setShowDownloadModal(false)}
                  ...
                  <div className="p-6 space-y-4">
                    ...
                    <div className="pt-4 border-t border-gray-200">
                      <p className="text-sm font-semibold text-gray-900 mb-3">Fonctionnalités de l'app :</p>
