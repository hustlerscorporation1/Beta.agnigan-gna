      ...
      <section className="contact-serction flex flex-wrap md:flex-nowrap gap-8 p-8 items-start">
        ...
        <div className="formulaire-contact bg-white p-6 shadow rounded w-full md:w-1/2">
          ...
          <form className="space-y-4">
            <input className="w-full border px-4 py-2 rounded" type="text" placeholder="Votre nom" />
            <input className="w-full border px-4 py-2 rounded" type="email" placeholder="Votre e-mail" />
            <input className="w-full border px-4 py-2 rounded" type="tel" placeholder="Votre numéro" />
            <textarea className="w-full border px-4 py-2 rounded" placeholder="Votre message" rows="4" />
            <button className="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700" type="submit">Envoi le message</button>
          </form>
        </div>

        {/* Contact Info */}
        <div className=" contact-info w-full md:w-1/2">
          <h2 className="text-xl font-semibold mb-4">N'hésitez pas à nous contacter.</h2>
          <div>
          ...
          <div className="mt-6 search-locate">
            <select name="" id="" className="border px-3 py-2 rounded" type="text" placeholder="Trouver une région">
            ...
            <button className="ml-2 bg-blue-600 text-white px-4 py-2 rounded">RECHERCHE</button>
          </div>
            ...
            <div className="App">
                <div className="map-container">
                    ...
                    {hoveredRegion ? (
                        ...
                        <p>Population (estimée) : {regionsData[hoveredRegion]?.population}</p>
                        {/* Ajoutez d'autres informations ici */}
                        </>
                    ) : (
                        <p className="affiche-region"><FaMapMarkerAlt className="aside-icon"/></p>
                    )}
                    </div>
                </div>
            </div>
