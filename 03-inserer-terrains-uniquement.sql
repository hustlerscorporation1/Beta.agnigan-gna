-- ================================================
-- DONNÉES D'EXEMPLE - UNIQUEMENT DES TERRAINS
-- ================================================
-- Ce script contient 15 terrains uniquement (résidentiels, agricoles, commerciaux, industriels)

-- ================================================
-- INSÉRER 15 TERRAINS UNIQUEMENT
-- ================================================
...
(gen_random_uuid(), 'Terrain Industriel Port de Lomé', 'Grand entrepôt proche du port, accès poids lourds.', '150000000 FCFA', 'Zone Portuaire, Lomé', 'industrial', 'available', '800 m²', 0, 2, 'https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?w=800', 145, NOW() - INTERVAL '6 days'),
...
(gen_random_uuid(), 'Terrain Industriel Kara', 'Terrain en attente. Zone industrielle, 1000m².', '25000000 FCFA', 'Kara, Région de la Kara', 'industrial', 'sold', '1000 m²', 0, 0, 'https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?w=800', 98, NOW() - INTERVAL '30 days'),

(gen_random_uuid(), 'Terrain Résidentiel Tsévié', 'Terrain résidentiel en négociation. 600m², viabilisé.', '9500000 FCFA', 'Tsévié, Togo', 'residential', 'sold', '600 m²', 0, 0, 'https://images.unsplash.com/photo-1500382017468-9049fed747ef?w=800', 76, NOW() - INTERVAL '20 days'),

-- TERRAINS EN ATTENTE (5)
(gen_random_uuid(), 'Terrain Commercial Hedzranawoé', 'Local commercial vendu. Bien situé sur axe passant.', '35000000 FCFA', 'Hedzranawoé, Lomé', 'commercial', 'pending', '95 m²', 0, 1, 'https://images.unsplash.com/photo-1497366811353-6870744d04b2?w=800', 198, NOW() - INTERVAL '8 days'),
...
-- ================================================
-- MESSAGES ADAPTÉS AUX TERRAINS UNIQUEMENT
-- ================================================
...
-- Total général
SELECT
    (SELECT COUNT(*) FROM properties) as total_terrains,
...
-- MESSAGE DE SUCCÈS
-- ================================================
SELECT '✅ Données terrains insérées avec succès! 15 terrains et 20 messages créés.' as statut;
